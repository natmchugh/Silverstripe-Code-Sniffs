 ...
 * @link      http://pear.php.net/package/PHP_CodeSniffer
 */
class Silverstripe_Sniffs_NamingConventions_ValidVariableNameSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff
{
	...
	if ($memberProps['is_static'] ) {
    	...
    	} else if (PHP_CodeSniffer::isCamelCaps($varName, false, $public, false) === false) {
